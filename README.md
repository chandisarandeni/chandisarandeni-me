<div align="center">
  ...
  <img src="./public/images/hero-screenshot.png" alt="Chandisa Randeni Portfolio - Hero Section" width="100%" style="border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);" />
</div>
