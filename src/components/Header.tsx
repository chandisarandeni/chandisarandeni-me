...
function Header({ email, github, linkedin }: HeaderProps) {
  return (
    <header className="mb-10 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-800 bg-slate-900/70 px-5 py-3 text-sm shadow-[0_8px_28px_rgba(0,0,0,0.3)]">
